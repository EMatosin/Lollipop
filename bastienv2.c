...
int main(int argc, char *argv[]) {
	...
	SDL_Surface *betbutton_txt;
	SDL_Rect posbetbutton_txt;
	TTF_Font *police;
	police = TTF_OpenFont ("Purple Smile.ttf",120);
	SDL_Color policeNoire = {0,0,0,255};
	betbutton_txt = TTF_RenderText_Blended(police, "BET", policeNoire);
	posbetbutton_txt.x = WIDTH/2;
	posbetbutton_txt.y = HEIGHT/2;
	SDL_BlitSurface(betbutton_txt, NULL, betbutton, &posbetbutton_txt);*/
